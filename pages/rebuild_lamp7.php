<?php
// Complete rebuild of Lampiran 7 block in cetak_lampiran.php
// Uses raw string injection to avoid PHP heredoc escape issues

$file = 'c:/xampp/htdocs/webdummy/pages/cetak_lampiran.php';
$content = file_get_contents($file);

// Find Lampiran 7 start and Lampiran 8 start
...
$start = $m7[0][1];
$end = $m8[0][1];
echo "Lampiran 7 starts at: $start, Lampiran 8 at: $end\n";

// Build the new Lampiran 7 content (raw PHP string - no heredoc)
$q = '"'; // double quote
$bs = '\\'; // backslash
$dq = '\\"'; // escaped double quote inside PHP string

// We'll write the new content as a PHP-string literal
$newLamp7 = '[ // Lampiran 7: Logbook Bimbingan
        \'isi\' => "
        <h3 style=' . $dq . 'text-align:center; font-size:14pt; margin-bottom:20px; font-weight:bold; font-family:Rockwell,serif;' . $dq . '>LOGBOOK BIMBINGAN TESIS</h3>
        ...
        <table style=' . $dq . 'width:100%; margin-bottom:20px; font-size:12pt; font-family:Rockwell,serif; border:none;' . $dq . '>
            ...
            <tr>
                <td class="py-3 px-4" style=' . $dq . 'vertical-align:top; font-weight:bold; padding-bottom:10px; border:none;' . $dq . '>Judul Tesis /<br><i style=' . $dq . 'font-weight:normal;' . $dq . '>Thesis Title</i></td>
                <td class="py-3 px-4" style=' . $dq . 'text-align:center; vertical-align:top; padding-bottom:10px; border:none;' . $dq . '>:</td>
