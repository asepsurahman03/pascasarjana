...
function processFile($filename) {
    ...
    if (preg_match('/(\[ \/\/ Lampiran 7:.*?)(,?\s*\[ \/\/ Lampiran 8:)/s', $content, $m, PREG_OFFSET_CAPTURE)) {
        ...
        $old_sig2 = '<table style="width:100%; border:none; text-align:center; font-size:11pt; font-family:Rockwell,serif;">
            <tr>
                <td class="py-3 px-4" style="width:33%; border:none; padding-bottom:5px; vertical-align:top;"></td>
                <td class="py-3 px-4" style="width:33%; border:none; padding-bottom:5px; vertical-align:top;"></td>
                <td class="py-3 px-4" style="width:34%; border:none; padding-bottom:5px; vertical-align:top;">Sukabumi, ............................ 2026</td>
            </tr>
            <tr>
                <td class="py-3 px-4" style="width:33%; border:none; padding-bottom:50px; vertical-align:bottom;">Mengetahui,<br><b style="display:block; margin-top:5px;">Ketua Program Studi Magister Informatika</b></td>
                <td class="py-3 px-4" style="width:33%; border:none; padding-bottom:50px; vertical-align:bottom; font-weight:bold;">Ketua Pembimbing,</td>
                <td class="py-3 px-4" style="width:34%; border:none; padding-bottom:50px; vertical-align:bottom; font-weight:bold;">Anggota Pembimbing,</td>
            </tr>
            <tr>
                <td class="py-3 px-4" style="border:none; padding-top:2px; padding-bottom:5px; vertical-align:bottom;">" . getTtdDosen($prodiData[\'nama_kaprodi\']) . e($prodiData[\'nama_kaprodi\']) . "</td>
                <td class="py-3 px-4" style="border:none; padding-top:2px; padding-bottom:5px; vertical-align:bottom;">" . getTtdDosen($ketuaPembimbing) . "$ketuaPembimbing</td>
                <td class="py-3 px-4" style="border:none; padding-top:2px; padding-bottom:5px; vertical-align:bottom;">" . getTtdDosen($anggotaPembimbing) . "$anggotaPembimbing</td>
            </tr>
        </table>';
        ...
        $lamp7_new = str_replace($old_sig, $new_sig, $lamp7);
        $lamp7_new = str_replace($old_sig2, $new_sig, $lamp7_new);
        
        // Also reduce table padding to 8px to ensure fit!
        $lamp7_new = str_replace("padding:15px;", "padding:8px;", $lamp7_new);
