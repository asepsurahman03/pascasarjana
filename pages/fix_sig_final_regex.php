...
function processFile($filename) {
    ...
    if (preg_match('/(\[ \/\/ Lampiran 7:.*?)(,?\s*\[ \/\/ Lampiran 8:)/s', $content, $m, PREG_OFFSET_CAPTURE)) {
        ...
        $lamp7_new = preg_replace('/<div style="font-size:12pt; font-family:Rockwell,serif; margin-bottom:30px;">/', '<div style="font-size:11pt; font-family:Rockwell,serif; margin-bottom:30px;">', $lamp7);
        
        // Use a more robust regex to replace the entire 3-column table
        $pattern = '/<table style="width:100%; border:none; text-align:center; font-size:(11pt|12pt); font-family:Rockwell,serif;">\s*<tr>\s*<td class="py-3 px-4" style="width:33%; border:none; padding-bottom:5px; vertical-align:top;"><\/td>\s*<td class="py-3 px-4" style="width:33%; border:none; padding-bottom:5px; vertical-align:top;"><\/td>\s*<td class="py-3 px-4" style="width:34%; border:none; padding-bottom:5px; vertical-align:top;">Sukabumi, \.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\.\. 2026<\/td>\s*<\/tr>.*?<\/table>/s';
        ...
        $lamp7_new = preg_replace($pattern, $new_sig, $lamp7_new);
